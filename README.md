...
The system allows teachers or administrators to create assignments, students to submit their work, and the AI evaluation engine to analyze submission based on the assignment requirements. The platform generates evaluation results, scores, feedback, and performance insights
